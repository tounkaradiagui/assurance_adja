                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="telepphone" type="text" class="form-control @error('telepphone') is-invalid @enderror" name="telepphone" value="{{ old('telepphone') }}" required autocomplete="telepphone" autofocus>
